...
const Header = class extends React.Component {
  ...
  render() {
    return (
      ...
      //   </nav>
      // </div>
      <div className="lg:px-16 px-6  flex flex-wrap items-center lg:py-0 py-2 w-full navbar-container justify-center lg:h-11 bg-black pb-2 lg:pb-0">
        ...
        <div class="hidden lg:flex lg:w-auto w-full" id="menu">
          <nav>
            <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
              <li><Link className="lg:px-2 py-2 px-0 block border-b-2 border-transparent hover:border-white text-white px-3 text-xxs font-open-sans" to="/">Home</Link></li>
              <li><Link className="lg:px-2 py-2 px-0 block border-b-2 border-transparent hover:border-white text-white px-3 text-xxs font-open-sans" to="/blog">Blog</Link></li>
              <li><Link className="lg:px-2 py-2 px-0 block border-b-2 border-transparent hover:border-white text-white px-3 text-xxs font-open-sans" to="/projects">Projects</Link></li>
              <li><Link className="lg:px-2 py-2 px-0 block border-b-2 border-transparent hover:border-white text-white px-3 text-xxs font-open-sans" to="/about">About</Link></li>
              <li><Link className="lg:px-2 py-2 px-0 block border-b-2 border-transparent hover:border-white lg:mb-0 mb-2 text-white px-3 text-xxs font-open-sans" to="/resume">Resume</Link></li>
            </ul>
          </nav>
        </div>
      </div>
